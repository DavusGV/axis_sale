    ...
    public function update(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'impresora_ticket' => 'nullable|string|max:255',
                'impresion_automatica' => 'required|boolean',
            ...
            $config = ConfiguracionEstablecimiento::updateOrCreate(
                ...
                [
                    ...
                    'impresora_ticket' => $request->impresora_ticket,
                    'impresion_automatica' => $request->impresion_automatica,
